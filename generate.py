...
def figure():
    files = glob.glob('/home/administrateur/nothing_wild_in_particular/figures/' + '*.txt')
...
def main():
    ...
    path = "/home/administrateur/nothing_wild_in_particular/backup/rnn_100_en_256_130_4_0.6.net"
